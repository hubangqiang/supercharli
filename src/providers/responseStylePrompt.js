function buildResponseStylePrompt(context = {}) {
  ...
  const lines = [
    ...
    "- Blend empathy and reasoning; do not sound like a generic counseling template.",
    "- Start from the user's concrete pressure point, then move to analysis and action.",
    ...
    "- anxiety_overload: emotional acknowledgment -> narrow battlefield -> immediate stop-loss action.",
    ...
    "- normal_coaching: direct diagnosis -> concrete suggestion -> clear execution handoff.",
    "",
